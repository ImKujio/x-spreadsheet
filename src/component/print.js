...
function getPPI() {
    ...
    // 读取计算后的宽度
    const ppi = window.getComputedStyle(div, null).getPropertyValue("width");
    // 移除元素
...
export default class Print {
    ...
    preview() {
        ...
        for (let i = 0; i < pages; i += 1) {
            let th = 0;
            let yo = 0;
            const wrap = h('div', `${cssPrefix}-canvas-card`).css("padding", padding + "px");
